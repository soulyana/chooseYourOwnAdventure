...
public class ChooseYourOwnAdventure {
	...
	public static void main(String[] args) {
		...
		String HEADER = "WELCOME TO ANNA'S & SOUL'S HOUSE OF HORRORS!";

		String ENDING1 = "You die of starvation... eventually.";
		...
		String ENDING6 = "Shortly after, a group of tribesman enter the room and invite you for dinner... but you are on the menu too!";

		String ENDING7 = "A gargoyle snaps your neck and drinks your blood!";
		String ENDING8 = "A gargoyle charges at you and chases you down the hallway and out of the top floor window! Too bad you don't have wings!";
		...
		else if (decision1.equals("upstairs")) 
		{
				...
				{
					System.out
							.println("You are in a creaking and dark hallway, with sharp-looking standing sculptures. "
									+ "There is a hanging chandelier on the verge of crashing down. In the end of the hallway, there is a protruding figure.  "
